...
var UserChatPageModule = /** @class */ (function () {
...
var UserChatPage = /** @class */ (function () {
    function UserChatPage(route, router, usersService, db, formBuilder, sendMessageService, chatService, authService, camera, chatPhotoService, modalController, fcm, mediaCapture, audioService, file, media) {
        this.route = route;
        this.router = router;
    ...
    UserChatPage.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { _this.content.scrollToBottom(); }, 100);
    };
    UserChatPage.prototype.getStatus = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.usersService.getUserStatus(this.friendData.friendId).subscribe(function (res) {
                    _this.online = res[1];
                    _this.date = res[0];
                });
                return [2 /*return*/];
    ...
    //     })
    // }
    UserChatPage.prototype.getMessages = function () {
        var _this = this;
        this.usersService.getCurrentUserMess(this.friendData.friendId, this.idLoggedUser).subscribe(function (mess) {
            _this.usersService.getFriendMess(_this.idLoggedUser, _this.friendData.friendId).subscribe(function (mes) {
                _this.messages = mes.concat(mess);
                _this.messages = _this.messages.sort(function (a, b) { return a.createdAt - b.createdAt; });
            });
        });
    };
    UserChatPage.prototype.sendMessage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var testo, data, minutes, zero, date;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                testo = this.form.value.message.trim();
                if (testo !== '') {
                    data = new Date;
                    ...
                    date = data.getHours() + ':' + (zero ? '0' : '') + minutes;
                    this.sendMessageService.send(this.idLoggedUser, this.friendData.friendId).push({
                        ...
                        _this.sendMessageService.newMessages(_this.friendData.friendId, _this.idLoggedUser).update({
                            newMess: true
                        });
                        _this.usersService.getLogUserData(_this.idLoggedUser).subscribe(function (res) {
                            _this.fcm.createNotification(res[1], res[2], _this.friendData.friendId, testo); //da inserire token recuperato dalla lista di token registrati corrispondente a quell 'id dell'amico
                        });
                        setTimeout(function () { _this.content.scrollToBottom(); }, 100);
                    });
                }
    ...
    UserChatPage.prototype.addCameraPhoto = function () {
        var _this = this;
        var options = {
            quality: 50,
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.sendPhotoMessage(base64Image);
        }, function (err) {
            alert(err);
        });
    };
    UserChatPage.prototype.sendPhotoMessage = function (image) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, minutes, zero, date;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.task.then(function () {
                    _this.chatPhotoService.upLoad(_this.idLoggedUser, _this.fileName).getDownloadURL().then(function (url) {
                        _this.urlPhoto = url;
                        setTimeout(function () { _this.content.scrollToBottom(); }, 200);
                        _this.usersService.getLogUserData(_this.idLoggedUser).subscribe(function (res) {
                            _this.chatPhotoService.savePhoto(_this.idLoggedUser, _this.friendData.friendId).push({
                                createdAt: Date.now(),
                                uid: _this.idLoggedUser,
                                text: '',
                                photo: _this.urlPhoto,
                                audio: '',
                                date: date
                            });
                        });
    ...
    UserChatPage.prototype.addAudio = function () {
        var _this = this;
        this.mediaCapture.captureAudio().then(function (audio) {
            console.log(audio);
            _this.file.checkFile(audio[0].fullPath, audio[0].name).then(function (res) {
                console.log(res);
            });
            var aud = 'data:audio/mpeg;base64url,' + audio[0].fullPath.toString();
            _this.sendAudioMessage(aud);
        });
        ////
    ...
    UserChatPage.prototype.sendAudioMessage = function (audio) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, minutes, zero, date, metadata;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.fileName = Date.now();
                data = new Date;
                ...
                this.task.then(function () {
                    _this.audioService.upLoadAudio(_this.idLoggedUser, _this.fileName).getDownloadURL().then(function (url) {
                        _this.urlAudio = url;
                        setTimeout(function () { _this.content.scrollToBottom(); }, 200);
                        _this.usersService.getLogUserData(_this.idLoggedUser).subscribe(function (res) {
                            _this.audioService.saveAudio(_this.idLoggedUser, _this.friendData.friendId).push({
                                createdAt: Date.now(),
                                uid: _this.idLoggedUser,
                                text: '',
                                photo: '',
                                audio: _this.urlAudio,
                                date: date
                            });
                        });
                    });
    ...
    UserChatPage.ctorParameters = function () { return [
...
var AudioService = /** @class */ (function () {
    function AudioService(storage, db) {
        this.storage = storage;
        this.db = db;
    }
    AudioService.prototype.upLoadAudio = function (idLogged, fileName) {
        return this.storage.storage.ref("messages/" + idLogged + "/" + fileName + ".mpeg");
    };
    AudioService.prototype.saveAudio = function (idLogged, idFriend) {
...
var ChatPhotoService = /** @class */ (function () {
    function ChatPhotoService(storage, db) {
        this.storage = storage;
        this.db = db;
    }
    ChatPhotoService.prototype.upLoad = function (idLogged, fileName) {
        return this.storage.storage.ref("messages/" + idLogged + "/" + fileName + ".jpg");
    };
    ChatPhotoService.prototype.savePhoto = function (idLogged, idFriend) {
        return this.db.database.ref("/chat/" + idLogged + "/" + idFriend + "/messages/");
    };
    ChatPhotoService.ctorParameters = function () { return [
        { type: _angular_fire_storage__WEBPACK_IMPORTED_MODULE_2__["AngularFireStorage"] },
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_1__["AngularFireDatabase"] }
    ]; };
...
//# sourceMappingURL=pages-user-chat-user-chat-module-es5.js.map