...
var UtentiPageModule = /** @class */ (function () {
    function UtentiPageModule() {
    }
...
var UtentiPage = /** @class */ (function () {
    function UtentiPage(userService, authService, chatService, router) {
        var _this = this;
        ...
        this.userService.getUsersData(this.idLoggedUser).subscribe(function (users) {
            _this.friends = users;
            console.log(users);
        });
    }
    UtentiPage.prototype.ngOnInit = function () {
    };
    UtentiPage.prototype.openChat = function (idFriend, firstnameFriend, lastnameFriend, photoFriend) {
        this.chatService.getClickedUserData(idFriend, firstnameFriend, lastnameFriend, photoFriend);
        this.router.navigate(['user-chat']);
    };
    UtentiPage.prototype.swipeRight = function () {
        this.router.navigateByUrl('/home/stato');
    };
    UtentiPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-utenti-utenti-module-es5.js.map